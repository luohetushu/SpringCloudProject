...
public class PaymentController {
    ...
    static {
        map.put(1L, new PaymentEntity(10001L, "支付9004序列号1"));
        map.put(2L, new PaymentEntity(10002L, "支付9004序列号2"));
        map.put(3L, new PaymentEntity(10003L, "支付9004序列号3"));
    }
    ...
    public CommonResult<PaymentEntity> getPaymentById(@PathVariable("id") Long id){
        ...
        return new CommonResult<>(200, "查询成功，支付9004, port: " + serverPort, payment);
    }
